...
export default function EditInvoiceForm({
  ...
  return (
    // 📦 ¿Por qué esto es útil en Server Actions?
    // Porque:

    // En <form action={...}>, Next espera una función que reciba el FormData

    // Pero vos querés pasar más cosas además del form, como un id

    // .bind() te deja “prellenar” esos argumentos, y Next los serializa bien
